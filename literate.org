...
#+TITLE:  Split and Join API Endpoints Webservice DevOps Doc
...
** DONE API Endpoint Function Requirements
| Spec ID | Description                                                                                     |
|---------+-------------------------------------------------------------------------------------------------|
...
** DONE F1 - Split string into even and odd character arrays, Assume first character 1, is odd
