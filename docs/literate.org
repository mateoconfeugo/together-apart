...
#+END_SRC
*** rsyslog
#+BEGIN_SRC ini :mkdir yes :tangle /etc/rsyslog.d/together_apart.conf
...
#+NAME: app-test-suite
#+BEGIN_SRC perl :noweb yes  :mkdirp yes :tangle Audition-WebService/t/acceptance.t
use Digest::SHA  qw(sha1);
